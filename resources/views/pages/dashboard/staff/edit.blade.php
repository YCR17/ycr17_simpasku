@php
    ...
    $avatar = $staff->avatar ?? 'default.jpg';
@endphp
...
@section('content')
                ...
                <div class="card w-100 position-relative overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            <img id="preview" src="{{ asset("storage/avatar/$avatar") }}" alt="avatar preview"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="info@pkuwsb.id" value="{{ $staff->email }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="fullname" name="fullname"
                                        placeholder="Maxima Studio" value="{{ $staff->fullname }}">
                                </div>
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Role</label>
                                    <select class="form-select" aria-label="Default select example" name="role">
                                        <option value="staff" {{ $staff->role == 'staff' ? 'selected' : '' }}>Staff
                                        </option>
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center justify-content-end mt-4 gap-3">
                                    ...
                                    <a href="{{ url('dashboard/staff') }}"
                                        class="btn btn-light-danger text-danger">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const defaultImg = "{{ asset("storage/avatar/$avatar") }}";
